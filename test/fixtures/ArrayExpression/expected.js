...
var _powerAssertConfig = ["assert(value, [message])", "assert.ok(value, [message])", "assert.equal(actual, expected, [message])", "assert.notEqual(actual, expected, [message])", "assert.strictEqual(actual, expected, [message])", "assert.notStrictEqual(actual, expected, [message])", { pattern: "assert.deepEqual(actual, expected, [message])", args: [{ name: "actual", options: { depth: 2 } }, { name: "expected", options: { depth: 2 } }, { name: "[message]", message: true }] }, { pattern: "assert.notDeepEqual(actual, expected, [message])", args: [{ name: "actual", options: { depth: 2 } }, { name: "expected", options: { depth: 2 } }, { name: "[message]", message: true }] }, { pattern: "assert.deepStrictEqual(actual, expected, [message])", args: [{ name: "actual", options: { depth: 2 } }, { name: "expected", options: { depth: 2 } }, { name: "[message]", message: true }] }, { pattern: "assert.notDeepStrictEqual(actual, expected, [message])", args: [{ name: "actual", options: { depth: 2 } }, { name: "expected", options: { depth: 2 } }, { name: "[message]", message: true }] }, { pattern: "assert.throws(fn, [error], [message])", args: [{ name: "fn", block: true }, { name: "[error]" }, { name: "[message]", message: true }] }, { pattern: "assert.doesNotThrow(fn, [error], [message])", args: [{ name: "fn", block: true }, { name: "[error]" }, { name: "[message]", message: true }] }, { pattern: "assert.rejects(asyncFn, [error], [message])", args: [{ name: "asyncFn", block: true }, { name: "[error]" }, { name: "[message]", message: true }] }, { pattern: "assert.doesNotReject(asyncFn, [error], [message])", args: [{ name: "asyncFn", block: true }, { name: "[error]" }, { name: "[message]", message: true }] }],
  ...
  espath: "arguments/0",
  code: "typeof [[foo.bar, baz(moo)], +fourStr] === 'number'",
  index: 0,
  name: "value",
  kind: "mandatory"
}),
  ...
  filepath: "test/fixtures/ArrayExpression/fixture.js",
  line: 7,
  config: _powerAssertConfig[7]
},
    _ag3 = new _ArgumentRecorder(assert.notDeepEqual, _am3, {
  espath: "arguments/0",
  code: "[foo, bar]",
  index: 0,
  name: "actual",
  kind: "mandatory"
    ...
    _ag4 = new _ArgumentRecorder(assert.notDeepEqual, _am3, {
  espath: "arguments/1",
  code: "[hoge, fuga, piyo]",
  index: 1,
  name: "expected",
...
assert(_ag._rec([_ag._tap(foo, "arguments/0/elements/0"), _ag._tap(bar, "arguments/0/elements/1")], "arguments/0"), new _AssertionMessage([_ag], _am));
assert(_ag2._rec(_ag2._tap(typeof _ag2._tap([_ag2._tap([_ag2._tap(_ag2._tap(foo, "arguments/0/left/argument/elements/0/elements/0/object").bar, "arguments/0/left/argument/elements/0/elements/0"), _ag2._tap(baz(_ag2._tap(moo, "arguments/0/left/argument/elements/0/elements/1/arguments/0")), "arguments/0/left/argument/elements/0/elements/1")], "arguments/0/left/argument/elements/0"), _ag2._tap(+_ag2._tap(fourStr, "arguments/0/left/argument/elements/1/argument"), "arguments/0/left/argument/elements/1")], "arguments/0/left/argument"), "arguments/0/left") === 'number', "arguments/0"), new _AssertionMessage([_ag2], _am2));
assert.notDeepEqual(_ag3._rec([_ag3._tap(foo, "arguments/0/elements/0"), _ag3._tap(bar, "arguments/0/elements/1")], "arguments/0"), _ag4._rec([_ag4._tap(hoge, "arguments/1/elements/0"), _ag4._tap(fuga, "arguments/1/elements/1"), _ag4._tap(piyo, "arguments/1/elements/2")], "arguments/1"), new _AssertionMessage([_ag3, _ag4], _am3));
