...
assert(_ag._rec({
  [_ag._tap(num, "arguments/0/properties/0/key")]: _ag._tap(foo, "arguments/0/properties/0/value")
}, "arguments/0"), new _AssertionMessage([_ag], _am));
assert(_ag2._rec({
  [_ag2._tap('prop_' + _ag2._tap((() => bar())(), "arguments/0/properties/0/key/right"), "arguments/0/properties/0/key")]: 42
}, "arguments/0"), new _AssertionMessage([_ag2], _am2));
assert(_ag3._rec({
  [_ag3._tap(`prop_${_ag3._tap(generate(_ag3._tap(seed, "arguments/0/properties/0/key/expressions/0/arguments/0")), "arguments/0/properties/0/key/expressions/0")}`, "arguments/0/properties/0/key")]: _ag3._tap(foo, "arguments/0/properties/0/value")
}, "arguments/0"), new _AssertionMessage([_ag3], _am3));
assert(_ag4._rec({
  foo
