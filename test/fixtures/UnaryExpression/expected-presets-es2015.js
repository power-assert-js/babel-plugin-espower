...
assert(assert._expr(assert._capt(assert._capt(typeof foo === 'undefined' ? 'undefined' : _typeof(foo), 'arguments/0/left') !== 'undefined', 'arguments/0'), {
  content: 'assert(typeof foo !== \'undefined\')',
  filepath: 'test/fixtures/UnaryExpression/fixture.js',
  line: 11
}));

assert(assert._expr(assert._capt(assert._capt(_typeof(assert._capt(assert._capt(foo, 'arguments/0/left/argument/object').bar, 'arguments/0/left/argument')), 'arguments/0/left') !== 'undefined', 'arguments/0'), {
  content: 'assert(typeof foo.bar !== \'undefined\')',
  filepath: 'test/fixtures/UnaryExpression/fixture.js',
  line: 13
}));

assert.strictEqual(assert._expr(assert._capt(typeof foo === 'undefined' ? 'undefined' : _typeof(foo), 'arguments/0'), {
  content: 'assert.strictEqual(typeof foo, typeof bar)',
  filepath: 'test/fixtures/UnaryExpression/fixture.js',
  line: 15
}), assert._expr(assert._capt(typeof bar === 'undefined' ? 'undefined' : _typeof(bar), 'arguments/1'), {
  content: 'assert.strictEqual(typeof foo, typeof bar)',
  filepath: 'test/fixtures/UnaryExpression/fixture.js',
  line: 15
}));
