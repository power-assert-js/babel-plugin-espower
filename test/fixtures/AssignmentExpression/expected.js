...
var _assert$_capt, _assert$_capt2, _assert$_capt3, _assert$_capt32;
...
assert(assert._expr(assert._capt((_assert$_capt3 = assert._capt([assert._capt(foo, 'arguments/0/right/elements/0')], 'arguments/0/right'), _assert$_capt32 = _slicedToArray(_assert$_capt3, 1), x = _assert$_capt32[0], _assert$_capt3), 'arguments/0'), {
