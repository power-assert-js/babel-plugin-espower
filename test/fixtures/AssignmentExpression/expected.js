...
assert(_ag6._rec([x] = _ag6._tap([3], "arguments/0/right"), "arguments/0"), new _AssertionMessage([_ag6], _am5));
assert(_ag7._rec([x] = _ag7._tap([_ag7._tap(foo, "arguments/0/right/elements/0")], "arguments/0/right"), "arguments/0"), new _AssertionMessage([_ag7], _am6));
