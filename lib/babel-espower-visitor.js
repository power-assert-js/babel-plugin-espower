...
BabelEspowerVisitor.prototype.enter = function (nodePath) {
    ...
    if (assertionVisitor) {
        ...
        if (matcher) {
            ...
            var enclosingFunction = this.findEnclosingFunction(nodePath);
            assertionVisitor = new BabelAssertionVisitor(this.babel, matcher, nodePath, enclosingFunction, espowerOptions);
...
BabelEspowerVisitor.prototype.findEnclosingFunction = function (nodePath) {
    if (!nodePath) {
        return null;
    }
