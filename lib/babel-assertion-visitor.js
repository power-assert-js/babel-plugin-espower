...
BabelAssertionVisitor.prototype.enterArgument = function (nodePath) {
    ...
    // TODO: want to know the index of matched argument

    if (argMatchResult.name === 'message' && argMatchResult.kind === 'optional') {
        // TODO: merge assertion recorder with message argument
...
BabelAssertionVisitor.prototype.captureAssertion = function (nodePath) {
    // TODO: merge assertion recorder with message argument
    var currentNode = nodePath.node;
    var newNode = this.createNewAssertionRecorder(nodePath);
    // TODO: rules for instrumentation
    //   1. if and only if the last argument is optional
    //   2. and the parameter is omitted
    //   3. and the other parameters are not omitted
    currentNode.arguments.push(newNode);
    return currentNode;
};

BabelAssertionVisitor.prototype.createNewAssertionRecorder = function (nodePath) {
    var _this = this;
    var t = this.babel.types;
    var currentNode = nodePath.node;
    var props = {
