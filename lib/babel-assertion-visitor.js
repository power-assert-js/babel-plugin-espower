...
BabelAssertionVisitor.prototype.getRecordHelperNameNode = function (nodePath) {
    ...
    var types = this.babel.types;
    var file = nodePath.hub.file;
    var helperNameNode = file.get('powerAssertRecorder');
    if (!helperNameNode) {
        helperNameNode = this.createNode(nodePath, 'powerAssertRecorder', function () {
...
BabelAssertionVisitor.prototype.getVisitorKeysNode = function (nodePath) {
    ...
    if (!visitorKeysIdent) {
        visitorKeysIdent = this.createNode(nodePath, 'powerAssertVisitorKeys', function () {
