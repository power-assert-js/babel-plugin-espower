...
BabelAssertionVisitor.prototype.leaveArgument = function (resultTree) {
    try {
        ...
        this.argumentModified = false;
        this.argumentRecorders.push(this.valueRecorder);
        this.valueRecorder = null;
    }
};
...
BabelAssertionVisitor.prototype.captureNode = function (nodePath) {
    ...
    var newNode = t.callExpression(
        t.memberExpression(this.valueRecorder, t.identifier('_tap')),
        [
            currentNode,
...
BabelAssertionVisitor.prototype.captureAssertion = function (nodePath) {
    ...
    var newNode = t.newExpression(assertionRecorderNameNode, [
        t.arrayExpression(this.argumentRecorders),
        propsNode
    ]);
    define(newNode, { _generatedByEspower: true });
...
BabelAssertionVisitor.prototype.captureArgument = function (node) {
    var t = this.babel.types;
    var newNode = t.callExpression(
        t.memberExpression(this.valueRecorder, t.identifier('_rec')),
        [
            node
        ]
    );
