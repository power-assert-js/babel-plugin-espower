...
var babelTemplate = require('@babel/core').template;
...
var assertionMessageHelperCode = '(' +
  fs.readFileSync(require.resolve('./assertion-message.js'), 'utf8')
    ...
    .join('\n')
  + ')()';
var argumentRecorderTemplate = function () {
    var ast = babelTemplate.ast(argumentRecorderHelperCode);
    return function (purify) {
        return purify(ast);
    };
}();
var assertionMessageTemplate = function () {
    var ast = babelTemplate.ast(assertionMessageHelperCode);
    return function (purify) {
        return purify(ast);
    };
}();
