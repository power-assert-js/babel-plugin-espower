...
const createNewAssertionMessage = ({ nodePath, types, visitorKeys, metadataIdent, cloneAst, originalMessageNode = null, matchIndex = -1 }) => {
  ...
  appendMessage (nodePath) {
    ...
    if (onlyLastArgumentIsOmitted) {
      ...
      if (this.toBeSkipped(lastActualArg)) {
        ...
        currentNode.arguments[lastIndex] = createNewAssertionMessage(Object.assign(params, { originalMessageNode, matchIndex }));
      }
    }
    return currentNode;
  }
