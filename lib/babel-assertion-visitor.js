...
BabelAssertionVisitor.prototype.enterArgument = function (nodePath) {
    ...
    var argMatchResult = this.patternMatcher.matcher.matchArgument(currentNode, parentNode);
    if (!argMatchResult) {
        return;
    }
...
BabelAssertionVisitor.prototype.appendMessage = function (nodePath) {
    ...
    var sigs = this.patternMatcher.matcher.argumentSignatures();
...
BabelAssertionVisitor.prototype.generateMetadata = function (nodePath) {
    ...
    if (typeof this.patternMatcher.index === 'number') {
        var configAccess = t.memberExpression(this.configIdent, t.valueToNode(this.patternMatcher.index), true);
