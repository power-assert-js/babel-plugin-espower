...
function BabelAssertionVisitor (babel, matcher, nodePath, options) {
    this.options = options || {};
    this.matcher = matcher;
    this.locationDetector = new EspowerLocationDetector(this.options);
    this.argumentModified = false;

    var enclosingFunc = findEnclosingFunction(babel, nodePath);
...
function findEnclosingFunction (babel, nodePath) {
    if (!nodePath) {
        return null;
    }
    ...
    return findEnclosingFunction(babel, nodePath.parentPath);
}
