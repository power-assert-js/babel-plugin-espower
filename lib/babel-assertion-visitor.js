      ...
      const funcNode = types.arrowFunctionExpression([
        ...
        types.returnStatement(types.callExpression(objectAssignMethod, [
          types.objectExpression([
            types.objectProperty(transpilerIdent, types.stringLiteral(pkg.name), false, false),
            types.objectProperty(versionIdent, types.stringLiteral(pkg.version), false, false),
