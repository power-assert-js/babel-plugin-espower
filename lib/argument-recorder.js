...
module.exports = /* intentional newline */
  function () {
    ...
    /**
     * proxy block argument then store its result as a Log
     * @param {any} value - actual value of target node
     * @param {string} espath - espath of target node in AST
     * @return {any} - the original value
     */
    ArgumentRecorder.prototype._blk = function _blk(value, espath) {
        var log = {
            value: wrap(value),
            espath: espath
        };
        this._logs.push(log);
        if (this._callee._empowered && typeof value === 'function') {
