...
module.exports = /* intentional newline */
  function () {
     ...
     * @property {number} index - index of target parameter
     * @property {string} name - name of target parameter
     * @property {string} kind - mandatory or optional
     */
     ...
     * @param {ArgumentMetadata} ag - tranpiler generated metadata for target argument
     */
    function ArgumentRecorder(callee, am, ag) {
        this._callee = callee;
        this._metadata = am;
        this._argDef = ag;
        this._logs = [];
        ...
        this._isBlock = false;
        if (am.config) {
            var argconf = am.config.args[ag.index];
    ...
    ArgumentRecorder.prototype._rec = function _rec(value, espath) {
        ...
        if (this._isBlock && this._callee && this._callee._empowered && typeof value === 'function') {
        ...
        this._logs = [];
        if (this._callee && this._callee._empowered) {
            return this;
        } else {
            return value;
        }
