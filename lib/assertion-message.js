...
class AssertionMessage {
    ...
    /**
     * @param {ArgumentRecorder[]} recs - ArgumentRecorder reference for each argument
     * @param {AssertionMetadata} am - AssertionMetadata for target assertion
     * @param {string|ArgumentRecorder} [message] - maybe enhanced message
     */
    constructor(recs, am, msgOrRec) {
        this._recs = recs;
        this._am = am;
    ...
    matchIndex() {
        ...
        return this._am.config.args.length - 1;
    }
    ...
    toString() {
        ...
        msg += `\n`;
        // msg += `\n`;
        // this._recs.forEach((rec) => {
        //     msg += `\n  arg${rec.matchIndex()}: ${rec.val()}`;
        // });
        // msg += '\n----------';
        return msg;
    }
